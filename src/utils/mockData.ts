...
export const generateNewsArticles = (): NewsArticle[] => {
  const articles = [
    ...
    },
    {
      ...
      aiSummary: "Tesla beats Q4 delivery estimates with record 484,507 vehicles. Strong momentum continues.",
    ...
    },
    {
      ...
      aiSummary: "Bitcoin ETF records $2.1B inflows. Institutional adoption accelerating rapidly.",
    ...
    },
    {
      ...
      aiSummary: "RBI holds repo rate at 6.5%. Focus shifts to balancing growth and inflation.",
      source: 'Economic Times' as const,
      impact: 'high' as const,
      sentiment: 65,
      sentimentLabel: '⚠️ Neutral' as const,
      category: 'policy' as const,
    ...
    },
    {
      ...
      aiSummary: "NVIDIA hits new highs on AI chip demand surge. Data center revenue up 206% YoY.",
      source: 'Bloomberg' as const,
      impact: 'medium' as const,
      sentiment: 90,
      sentimentLabel: '🚀 Bullish' as const,
    ...
    {
      headline: "Reliance Industries Q3 Results: Beats Estimates on Petrochemicals Growth",
      summary: "India's largest private company reports strong quarterly results driven by petrochemicals division performance and retail expansion.",
      aiSummary: "Reliance beats Q3 estimates. Petrochemicals and retail drive growth.",
      source: 'Economic Times' as const,
      impact: 'high' as const,
      sentiment: 82,
      sentimentLabel: '🚀 Bullish' as const,
      category: 'earnings' as const,
      relatedAssets: ['RELIANCE', 'NIFTY'],
      relevanceScore: 89,
    },
  ];
...
export const generatePortfolioAssets = (): PortfolioAsset[] => {
  const assets = [
    ...
    { symbol: 'RELIANCE', name: 'Reliance Industries', purchasePrice: 2450 },
    { symbol: 'TCS', name: 'Tata Consultancy Services', purchasePrice: 3680 },
  ];
